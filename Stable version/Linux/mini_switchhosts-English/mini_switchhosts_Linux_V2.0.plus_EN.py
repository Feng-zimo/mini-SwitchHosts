...
class HostsManager(QMainWindow):
    ...
    def on_apply_result(self, result):
        ...
        if result['success']:
            ...
            self.log("💡 Suggested to flush DNS cache: sudo systemctl restart NetworkManager (Linux)")
            QMessageBox.information(self, "Success",
                                    f"{target_name} rules applied successfully!\n\nSuggested to run in terminal: sudo systemctl restart NetworkManager to flush DNS cache")
