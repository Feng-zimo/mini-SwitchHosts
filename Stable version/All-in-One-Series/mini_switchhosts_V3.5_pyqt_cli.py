...
# -*- coding: utf-8 -*-
"""
mini-SwitchHosts PyQt CLI v3.5
Command-line version for GitHub & Replit Hosts management with PyQt support
...
def show_version():
    ...
    print("mini-SwitchHosts PyQt CLI v3.5")
    print("GitHub & Replit Hosts Manager (Command-Line Edition with PyQt support)")
...
def show_help():
    ...
    print("mini-SwitchHosts PyQt CLI v3.5")
    print("Usage: python mini_switchhosts_V3.5_pyqt_cli.py [OPTIONS]")
    print("")
    print("Options:")
    ...
    print("")
    print("Examples:")
    print("  python mini_switchhosts_V3.5_pyqt_cli.py -d -t github")
    print("    Download latest GitHub rules")
    print("  python mini_switchhosts_V3.5_pyqt_cli.py -d -a -t replit")
    print("    Download and apply latest Replit rules")
    print("  python mini_switchhosts_V3.5_pyqt_cli.py -b")
    print("    Create backup of current hosts file")
    print("  python mini_switchhosts_V3.5_pyqt_cli.py -r")
    print("    Restore hosts file from latest backup")
    print("  python mini_switchhosts_V3.5_pyqt_cli.py -r backups/hosts_backup_20251201_120000.txt")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="mini-SwitchHosts PyQt CLI - Command-line tool for managing GitHub & Replit hosts rules",
        add_help=False
    )
